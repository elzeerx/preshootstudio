    ...
    <div className="min-h-screen bg-background" dir="rtl">
      <div className="container max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card variant="editorial" className="hover:shadow-editorial-hover transition-all">
          ...
          <Card variant="editorial" className="hover:shadow-editorial-hover transition-all">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <FolderOpen className="w-5 h-5 text-secondary" strokeWidth={1.5} />
            </CardHeader>
            <CardContent>
          ...
          <Card variant="editorial" className="hover:shadow-editorial-hover transition-all">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-foreground">{stats.totalBetaSignups}</div>
              <p className="text-xs text-muted-foreground mt-1">
          ...
          <Card variant="editorial" className="hover:shadow-editorial-hover transition-all">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-foreground">{stats.approvedSignups}</div>
              <p className="text-xs text-muted-foreground mt-1">
