...
/**
 * Research Model System Prompt V2 - With Tavily Web Search
 * Used for processing real web search results from Tavily API
 * 
 * UPDATED: Enhanced for structured JSON output with REAL web sources
 */
export const RESEARCH_SYSTEM_PROMPT_V2 = `أنت باحث وصحفي تقني محترف، وتكتب باللغة العربية الفصحى المبسّطة.
